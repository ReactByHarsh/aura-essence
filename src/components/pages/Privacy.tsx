      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="prose prose-lg max-w-none text-slate-600 dark:text-slate-300">
          ...
          <section className="mb-10">
            ...
            <h3 className="text-lg font-semibold text-slate-800 dark:text-gray-100 mb-3 mt-6">Information We Obtain from Third Parties</h3>
            ...
            <ul className="list-disc list-inside space-y-2 mb-4 text-slate-700 dark:text-gray-200">
              ...
              <li>Our payment processors, who collect payment information (e.g., bank account, credit or debit card information, billing address) to process your payment in order to fulfill your orders and provide you with products or services you have requested</li>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-lg font-semibold text-slate-800 dark:text-gray-100 mb-3">Providing Products and Services</h3>
            ...
            <h3 className="text-lg font-semibold text-slate-800 dark:text-gray-100 mb-3">Marketing and Advertising</h3>
            <p className="mb-4 text-slate-700 dark:text-gray-200">
            ...
            <h3 className="text-lg font-semibold text-slate-800 dark:text-gray-100 mb-3">Security and Fraud Prevention</h3>
            <p className="mb-4 text-slate-700 dark:text-gray-200">
            ...
            <h3 className="text-lg font-semibold text-slate-800 dark:text-gray-100 mb-3">Communicating with You and Service Improvement</h3>
            <p className="text-slate-700 dark:text-gray-200">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-3 mb-4 text-slate-700 dark:text-gray-200">
          ...
          <section className="mb-8">
            ...
            <ul className="space-y-4 mb-6 text-slate-700 dark:text-gray-200">
              <li>
              ...
              <li>
                <strong>Appeal:</strong> You may have a right to appeal our decision if we decline to process your request. You can do so by replying directly to our denial.
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-700 dark:text-gray-200">
              If we transfer your personal information out of India, we will rely on recognized transfer mechanisms as permitted by applicable law, unless the data transfer is to a country that has been determined to provide an adequate level of protection.
            </p>
          </section>
